...
` : "";
  ...
  const angleGuidelines: Record<string, string> = {
    BEFORE_AFTER: "ESTRUTURA 'BEFORE VS AFTER': Foque em comparar código antigo/legado com dezenas de linhas de boilerplate contra a versão moderna e limpa. Deixe as diferenças de sintaxe e clareza explícitas.",
    HOT_TAKE: "ESTRUTURA 'HOT TAKE': Comece com uma tese provocativa e contra-intuitiva, desconstrua o consenso raso da comunidade e apresente uma fundamentação técnica sólida.",
    MIGRATION_GUIDE: "ESTRUTURA 'MIGRATION GUIDE': Apresente um checklist passo a passo prático para atualizar a stack, alertando sobre breaking changes e armadilhas comuns.",
    SENIOR_REVIEW: "ESTRUTURA 'SENIOR REVIEW': Analise como um arquiteto com 10 anos de experiência: separe o que é hype de marketing do que realmente importa e sobrevive em produção real.",
    BREAKING_NEWS: "ESTRUTURA 'BREAKING NEWS': Destaque o lançamento/novidade tech com impacto imediato, explicando as 3 principais mudanças e para quem isso importa hoje.",
    DEEP_DIVE: "ESTRUTURA 'DEEP DIVE': Dissecação técnica por baixo dos panos (internals, ponte de memória, AST ou protocolo) para desenvolvedores experientes.",
    COMMUNITY_PULSE: "ESTRUTURA 'COMMUNITY PULSE': Repercussão do ecossistema tech, debates de fóruns (Reddit/X/GitHub) e métricas de adoção.",
    TLDR_SUMMARY: "ESTRUTURA 'TL;DR SUMMARY': Resumo condensado e objetivo em tópicos rápidos de 2 minutos para leitura ágil.",
    STEP_BY_STEP_TUTORIAL: "ESTRUTURA 'TUTORIAL PASSO A PASSO': Guia progressivo de implementação com código funcional do início ao fim.",
  };

  const currentAngleGuideline = angleGuidelines[narrativeAngle] || angleGuidelines.BEFORE_AFTER;
...
- Tema: ${decision.topic}
- Ângulo Narrativo: ${narrativeAngle}
